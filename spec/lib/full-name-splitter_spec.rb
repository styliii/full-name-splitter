...
describe Incognito do
  describe "#full_name=" do
    ...
    {
      "John Smith"                    => ["John",     nil,        "Smith"             ],
      "Kevin J. O'Connor"             => ["Kevin",    "J.",      "O'Connor"           ],
      "Gabriel Van Helsing"           => ["Gabriel",  nil,      "Van Helsing"         ],
      "Pierre de Montesquiou"         => ["Pierre",   nil,      "de Montesquiou"      ],
      "Charles d'Artagnan"            => ["Charles",  nil,      "d'Artagnan"          ],
      "Jaazaniah ben Shaphan"         => ["Jaazaniah", nil,     "ben Shaphan"         ],
      "Noda' bi-Yehudah"              => ["Noda'",    nil,      "bi-Yehudah"          ],
      "Maria del Carmen Menendez"     => ["Maria",    nil,      "del Carmen Menendez" ],
      "Alessandro Del Piero"          => ["Alessandro",  nil,   "Del Piero"           ],
      ...
      "George Bush Jr."                 => ["George",  nil,     "Bush"               ],
      ...
      "Juan Martín de la Cruz Gómez Sr."  => ["Juan", "Martín",    "de la Cruz Gómez"    ],
      "Javier Reyes de la Barrera"    => ["Javier", "Reyes",        "de la Barrera" ],
      "Rosa María Pérez Martínez Vda. de la Cruz" =>
                                         ["Rosa", "María Pérez Martínez",   "Vda. de la Cruz"],

      # Italian
      "Federica Pellegrini"           => ["Federica",  nil,     "Pellegrini"          ],
      "Leonardo da Vinci"             => ["Leonardo",  nil,     "da Vinci"            ],
